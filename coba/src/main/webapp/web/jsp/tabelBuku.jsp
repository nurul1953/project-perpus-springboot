    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <c:url var="insert" value="/insertBuku">
                        </c:url>
                        <a href="${insert}">Tambah Data Buku</a>
                    </div>
                </div>
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form:form action="/searchBuku" modelAttribute="cari" method="POST">
                        ...
                        <table id="datatablesSimple">
                            ...
                            <c:forEach var="buku" items="${Buku}">
                                <tr>
                                    ...
                                    <td>${buku.penerbit}</td>
                                    <td>
                                        <c:url var="updateBuku" value="/updateBuku">
                                            <c:param name="id" value="${buku.id}"/>
                                        </c:url>
                                        <a href="${updateBuku}">Ubah</a>
                                        <c:url var="deleteBuku" value="/deleteBuku">
                                            <c:param name="id" value="${buku.id}"/>
                                        </c:url>
                                        <a href="${deleteBuku}">Hapus</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
