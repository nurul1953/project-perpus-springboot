    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <c:url var="insert" value="/insertAnggota">
                        </c:url>
                        <a href="${insert}">Tambah Data Anggota</a>
                    </div>
                </div>
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form:form action="/searchAnggota" modelAttribute="cari" method="POST">
                        ...
                        <table id="datatablesSimple">
                            ...
                            <c:forEach var="anggota" items="${Anggota}">
                                <tr>
                                    ...
                                    <td>
                                        <c:url var="updateAnggota" value="/updateAnggota">
                                            <c:param name="id" value="${anggota.id}"/>
                                        </c:url>
                                        <a href="${updateAnggota}">Ubah</a>
                                        <c:url var="deleteAnggota" value="/deleteAnggota">
                                            <c:param name="id" value="${anggota.id}"/>
                                        </c:url>
                                        <a href="${deleteAnggota}">Hapus</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
