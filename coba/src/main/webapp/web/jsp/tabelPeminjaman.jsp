    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <c:url var="insert" value="/insertPeminjaman">
                        </c:url>
                        <a href="${insert}">Tambah Data Peminjaman</a>
                    </div>
                </div>
                <div class="card mb-4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <c:url var="updatePeminjaman" value="/updatePeminjaman">
                                            <c:param name="id" value="${peminjaman.id}"/>
                                        </c:url>
                                        <a href="${updatePeminjaman}">Ubah</a>
                                        <c:url var="deleteAnggota" value="/deletePeminjammna">
                                            <c:param name="id" value="${peminjaman.id}"/>
                                        </c:url>
                                        <a href="${deletePeminjaman}">Hapus</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
